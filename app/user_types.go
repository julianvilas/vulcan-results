...
type rawPayload struct {
	// Check UUID
	CheckID *uuid.UUID `form:"check_id,omitempty" json:"check_id,omitempty" xml:"check_id,omitempty"`
	...
	// Scan UUID
	ScanID *uuid.UUID `form:"scan_id,omitempty" json:"scan_id,omitempty" xml:"scan_id,omitempty"`
	// Scan start time
	ScanStartTime *time.Time `form:"scan_start_time,omitempty" json:"scan_start_time,omitempty" xml:"scan_start_time,omitempty"`
}
...
type reportPayload struct {
	...
	Report *string `form:"report,omitempty" json:"report,omitempty" xml:"report,omitempty"`
	// Scan UUID
	ScanID *uuid.UUID `form:"scan_id,omitempty" json:"scan_id,omitempty" xml:"scan_id,omitempty"`
	// Scan start time
	ScanStartTime *time.Time `form:"scan_start_time,omitempty" json:"scan_start_time,omitempty" xml:"scan_start_time,omitempty"`
